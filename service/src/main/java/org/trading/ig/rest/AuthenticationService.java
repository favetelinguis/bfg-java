...
import org.trading.ig.rest.dto.session.createSessionV3.CreateSessionV3Response;
...
public class AuthenticationService extends AbstractService {
   ...
   public AuthenticationResponseAndConversationContext createSession(
       CreateSessionV1Request authenticationRequest, String apiKey) {
   ...
   protected ResponseEntity<CreateSessionV2Response> authenticate(CreateSessionV2Request request, String apiKey) {
      ConversationContext conversationContext = new ConversationContextV2(null, null, apiKey);
      String uri = "/session";

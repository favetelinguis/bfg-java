...
import org.trading.ig.rest.AbstractService;
import org.trading.ig.rest.AuthenticationResponseAndConversationContext;
import org.trading.ig.rest.AuthenticationService;
import org.trading.ig.rest.ConversationContext;
import org.trading.ig.rest.HttpDeleteWithBody;
import org.trading.ig.rest.dto.application.disable.updateApplicationV1.UpdateApplicationV1Response;
import org.trading.ig.rest.dto.application.getApplicationsV1.GetApplicationsV1ResponseItem;
import org.trading.ig.rest.dto.application.updateApplicationV1.UpdateApplicationV1Request;
import org.trading.ig.rest.dto.clientsentiment.getClientSentimentV1.GetClientSentimentV1Response;
import org.trading.ig.rest.dto.clientsentiment.getRelatedClientSentimentV1.GetRelatedClientSentimentV1Response;
import org.trading.ig.rest.dto.getAccountsV1.GetAccountsV1Response;
import org.trading.ig.rest.dto.getDealConfirmationV1.GetDealConfirmationV1Response;
import org.trading.ig.rest.dto.history.getActivityHistoryByTimeRangeV1.GetActivityHistoryByTimeRangeV1Response;
import org.trading.ig.rest.dto.history.getActivityHistoryV1.GetActivityHistoryV1Response;
import org.trading.ig.rest.dto.history.getActivityHistoryV2.GetActivityHistoryV2Response;
import org.trading.ig.rest.dto.history.getActivityHistoryV3.GetActivityHistoryV3Response;
import org.trading.ig.rest.dto.history.getTransactionHistoryByTimeRangeV1.GetTransactionHistoryByTimeRangeV1Response;
import org.trading.ig.rest.dto.history.getTransactionHistoryV1.GetTransactionHistoryV1Response;
import org.trading.ig.rest.dto.history.getTransactionHistoryV2.GetTransactionHistoryV2Response;
import org.trading.ig.rest.dto.markets.getMarketDetailsBySearchTermV1.GetMarketDetailsBySearchTermV1Response;
import org.trading.ig.rest.dto.markets.getMarketDetailsListV1.GetMarketDetailsListV1Response;
import org.trading.ig.rest.dto.markets.getMarketDetailsListV2.GetMarketDetailsListV2Response;
import org.trading.ig.rest.dto.markets.getMarketDetailsV1.GetMarketDetailsV1Response;
import org.trading.ig.rest.dto.markets.getMarketDetailsV2.GetMarketDetailsV2Response;
import org.trading.ig.rest.dto.markets.getMarketDetailsV3.GetMarketDetailsV3Response;
import org.trading.ig.rest.dto.markets.navigation.getMarketNavigationNodeV1.GetMarketNavigationNodeV1Response;
import org.trading.ig.rest.dto.markets.navigation.getMarketNavigationRootV1.GetMarketNavigationRootV1Response;
import org.trading.ig.rest.dto.positions.getPositionByDealIdV1.GetPositionByDealIdV1Response;
import org.trading.ig.rest.dto.positions.getPositionByDealIdV2.GetPositionByDealIdV2Response;
import org.trading.ig.rest.dto.positions.getPositionsV1.GetPositionsV1Response;
import org.trading.ig.rest.dto.positions.getPositionsV2.GetPositionsV2Response;
import org.trading.ig.rest.dto.positions.otc.closeOTCPositionV1.CloseOTCPositionV1Request;
import org.trading.ig.rest.dto.positions.otc.closeOTCPositionV1.CloseOTCPositionV1Response;
import org.trading.ig.rest.dto.positions.otc.createOTCPositionV1.CreateOTCPositionV1Request;
import org.trading.ig.rest.dto.positions.otc.createOTCPositionV1.CreateOTCPositionV1Response;
import org.trading.ig.rest.dto.positions.otc.createOTCPositionV2.CreateOTCPositionV2Request;
import org.trading.ig.rest.dto.positions.otc.createOTCPositionV2.CreateOTCPositionV2Response;
import org.trading.ig.rest.dto.positions.otc.updateOTCPositionV1.UpdateOTCPositionV1Request;
import org.trading.ig.rest.dto.positions.otc.updateOTCPositionV1.UpdateOTCPositionV1Response;
import org.trading.ig.rest.dto.positions.otc.updateOTCPositionV2.UpdateOTCPositionV2Request;
import org.trading.ig.rest.dto.positions.otc.updateOTCPositionV2.UpdateOTCPositionV2Response;
import org.trading.ig.rest.dto.positions.sprintmarkets.createSprintMarketPositionV1.CreateSprintMarketPositionV1Request;
import org.trading.ig.rest.dto.positions.sprintmarkets.createSprintMarketPositionV1.CreateSprintMarketPositionV1Response;
import org.trading.ig.rest.dto.positions.sprintmarkets.getSprintMarketPositionsV1.GetSprintMarketPositionsV1Response;
import org.trading.ig.rest.dto.positions.sprintmarkets.getSprintMarketPositionsV2.GetSprintMarketPositionsV2Response;
import org.trading.ig.rest.dto.prices.getPricesByDateRangeV1.GetPricesByDateRangeV1Response;
import org.trading.ig.rest.dto.prices.getPricesByDateRangeV2.GetPricesByDateRangeV2Response;
import org.trading.ig.rest.dto.prices.getPricesByNumberOfPointsV1.GetPricesByNumberOfPointsV1Response;
import org.trading.ig.rest.dto.prices.getPricesByNumberOfPointsV2.GetPricesByNumberOfPointsV2Response;
import org.trading.ig.rest.dto.prices.getPricesV3.GetPricesV3Response;
import org.trading.ig.rest.dto.session.createSessionV1.CreateSessionV1Request;
import org.trading.ig.rest.dto.session.createSessionV1.CreateSessionV1Response;
import org.trading.ig.rest.dto.session.createSessionV2.CreateSessionV2Request;
import org.trading.ig.rest.dto.session.createSessionV2.CreateSessionV2Response;
import org.trading.ig.rest.dto.session.createSessionV3.AccessTokenResponse;
import org.trading.ig.rest.dto.session.createSessionV3.CreateSessionV3Request;
import org.trading.ig.rest.dto.session.encryptionKey.getEncryptionKeySessionV1.GetEncryptionKeySessionV1Response;
import org.trading.ig.rest.dto.session.getSessionV1.GetSessionV1Response;
import org.trading.ig.rest.dto.session.refreshSessionV1.RefreshSessionV1Request;
import org.trading.ig.rest.dto.session.updateActiveAccountV1.UpdateActiveAccountV1Request;
import org.trading.ig.rest.dto.session.updateActiveAccountV1.UpdateActiveAccountV1Response;
import org.trading.ig.rest.dto.watchlists.createWatchlistV1.CreateWatchlistV1Request;
import org.trading.ig.rest.dto.watchlists.createWatchlistV1.CreateWatchlistV1Response;
import org.trading.ig.rest.dto.watchlists.deleteWatchlistMarketV1.DeleteWatchlistMarketV1Response;
import org.trading.ig.rest.dto.watchlists.deleteWatchlistV1.DeleteWatchlistV1Response;
import org.trading.ig.rest.dto.watchlists.getWatchlistByWatchlistIdV1.GetWatchlistByWatchlistIdV1Response;
import org.trading.ig.rest.dto.watchlists.getWatchlistsV1.GetWatchlistsV1Response;
import org.trading.ig.rest.dto.watchlists.updateWatchlistMarketV1.UpdateWatchlistMarketV1Request;
import org.trading.ig.rest.dto.watchlists.updateWatchlistMarketV1.UpdateWatchlistMarketV1Response;
import org.trading.ig.rest.dto.workingorders.getWorkingOrdersV1.GetWorkingOrdersV1Response;
import org.trading.ig.rest.dto.workingorders.getWorkingOrdersV2.GetWorkingOrdersV2Response;
import org.trading.ig.rest.dto.workingorders.otc.createOTCWorkingOrderV1.CreateOTCWorkingOrderV1Request;
import org.trading.ig.rest.dto.workingorders.otc.createOTCWorkingOrderV1.CreateOTCWorkingOrderV1Response;
import org.trading.ig.rest.dto.workingorders.otc.createOTCWorkingOrderV2.CreateOTCWorkingOrderV2Request;
import org.trading.ig.rest.dto.workingorders.otc.createOTCWorkingOrderV2.CreateOTCWorkingOrderV2Response;
import org.trading.ig.rest.dto.workingorders.otc.deleteOTCWorkingOrderV1.DeleteOTCWorkingOrderV1Request;
import org.trading.ig.rest.dto.workingorders.otc.deleteOTCWorkingOrderV1.DeleteOTCWorkingOrderV1Response;
import org.trading.ig.rest.dto.workingorders.otc.deleteOTCWorkingOrderV2.DeleteOTCWorkingOrderV2Response;
import org.trading.ig.rest.dto.workingorders.otc.updateOTCWorkingOrderV1.UpdateOTCWorkingOrderV1Request;
import org.trading.ig.rest.dto.workingorders.otc.updateOTCWorkingOrderV1.UpdateOTCWorkingOrderV1Response;
import org.trading.ig.rest.dto.workingorders.otc.updateOTCWorkingOrderV2.UpdateOTCWorkingOrderV2Request;
import org.trading.ig.rest.dto.workingorders.otc.updateOTCWorkingOrderV2.UpdateOTCWorkingOrderV2Response;
...
public AuthenticationResponseAndConversationContext createSession(
  ...
  return authenticationService.createSession(authenticationRequest, apiKey);
}

  public AuthenticationResponseAndConversationContext createSessionV3(
      CreateSessionV3Request authenticationRequest, String apiKey) {
...
*/
public org.trading.ig.rest.dto.application.updateApplicationV1.UpdateApplicationV1Response updateApplicationV1(ConversationContext conversationContext, UpdateApplicationV1Request request) throws Exception {
  String uri = "/operations/application";
  HttpEntity<?> requestEntity = buildHttpEntity(conversationContext, request, "1");
  ResponseEntity<org.trading.ig.rest.dto.application.updateApplicationV1.UpdateApplicationV1Response> response = restTemplate.exchange(getIGApiDomainURL() + addIGApiLightDarkCluster(uri), HttpMethod.PUT, requestEntity, org.trading.ig.rest.dto.application.updateApplicationV1.UpdateApplicationV1Response.class);
  return response.getBody();
}

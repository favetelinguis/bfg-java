...
public class GetOpeningRangeExecutor implements Channel {

  private static Logger LOG = LoggerFactory.getLogger(GetOpeningRangeExecutor.class);
  private final IgRestService igRestService;
  private final KieSession kieSession;

  public GetOpeningRangeExecutor(IgRestService igRestService, KieSession kieSession) {
